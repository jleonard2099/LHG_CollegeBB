- Improved array handling / assignment
- Updated routines that printed custom char's (boxes, prompts, etc.) to use Chr$ references instead of literal strings
...
- Removed almost all spaghetti code for easy flow and readability
- Created several subroutines for menus and utilities to better modularize source
