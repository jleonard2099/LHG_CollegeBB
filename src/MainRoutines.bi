...
Declare Sub CareerToPrinter (printDest, destFile$, carviewA$(), careerFile$)
...
Declare Sub SaveChangedData (fileName$, teamIdx)
...
Declare Sub ViewRoster (printDest, destFile$, teamName$)
