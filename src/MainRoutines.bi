...
Declare Sub CalcStatLeadersNat (statFile$, TN$)
Declare Sub CalcStatTotalsConf (TN$)
Declare Sub CalcStatTotalsConf (numberGames, TN$, finalUpdate$)
Declare Sub CalcStatTotalsTeam (TN$)
...
Declare Sub ReadStatsConf (statFile$, TN$)
